...
std::unique_ptr<Matcher::MatchLayer> Matcher::construct_new_layer(std::vector<std::string> current_tokens, std::string matched_token){
    if (matched_token != ""){
...
std::vector<std::string> Matcher::get_tokens(){
